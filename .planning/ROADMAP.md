...
**Plans:** 6 plans
- [ ] 55-01-PLAN.md — Wave 0 RED scaffolds: BlockContext extension + RED tests for if_note_type_*, if_flag_*, predicate_flags validation
- [ ] 55-02-PLAN.md — GREEN: if_note_type_<X> regex + evaluator branch + validate_template guard + render_note plumbing
- [ ] 55-03-PLAN.md — GREEN: predicate_flags: profile key + _validate_predicate_flags + if_flag_<name> evaluator + preflight cross-check
- [ ] 55-04-PLAN.md — Doc-fence-as-fixture loader (tests/test_docs_templates_examples.py)
